...
while (guestList.length > 2) {
    ...
    console.log("SORRY,".concat(removeguests, ",i cant invited you for dinner"));
}
//sending a invitation for last two guests
console.log("Invitations to the last two guests");
guestList.forEach(function (lasttwoguests) { return console.log("Luckily ".concat(lasttwoguests, ",you are still invted for dinner")); });
